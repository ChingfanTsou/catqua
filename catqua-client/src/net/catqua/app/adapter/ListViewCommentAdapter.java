package net.catqua.app.adapter;

import java.util.List;

import net.catqua.app.R;
import net.catqua.app.bean.Comment;
import net.catqua.app.bean.Comment.Refer;
import net.catqua.app.bean.Comment.Reply;
import net.catqua.app.common.BitmapManager;
